...
public class MyCBRImportTest extends TestCase {
	...
	public void testMyCBRImport1() {
		...
		try {
			...
			Project project = new Project("C:\\mycbr\\projects\\MyCBRImportTest1\\MyCBRImportTest_CBR_SMF.XML");
	...
	public void testUsedCarsFlat() {
		try {
			...
			Project project = new Project("C:\\mycbr\\projects\\UsedCarsFlat\\used_cars_flat_CBR_SMF.XML");
			LinkedList<Double> results;
			Concept car = project.getConceptByID("Car");
	...
	public void testProject() {
		try {
			...
			new Project("C:\\mycbr\\projects\\Testproject\\Testproject_CBR_SMF.XML");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
